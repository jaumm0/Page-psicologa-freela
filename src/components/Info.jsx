    ...
    return(
        ...
        >
            ...
            >
                ...
                <ul
                className="font-inter font-medium text-ulheader grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 gap-4 text-sm w-120 place-items-center"
                >
                    <li
                    ...
                    <li
                    className="bg-bgIcon h-8 flex justify-center text-textmain items-center w-50 rounded-xl shadow-lg"
                    >
                        <span
                        className="w-100"
                        >
