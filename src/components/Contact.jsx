  ...
  return (
    <section id="Contact" className="grid lg:grid-cols-2  md:grid-cols-2 sm:grid-cols-1 w-90  sm:w-full md:w-full lg:w-full place-self-center text-justify lg:px-20 md:px-10 sm:px-6 lg:py-16 md:py-12 sm:py-10 gap-8 place-items-center">
      <div className="bg-textmain lg:w-full md:w-full sm:w-full lg:h-auto md:h-auto sm:h-auto place-items-center flex justify-center items-center rounded-xl shadow-lg">
        <section className="font-medium text-white text-justify lg:px-8 h-90 sm:h-130 md:px-6 sm:px-5 lg:mb-6  sm:mb-4 lg:py-8 md:py-6 sm:py-5 grid lg:grid-rows-4 md:grid-rows-4 sm:grid-rows-1 gap-3">
          ...
          <p className="font-inter px-4 sm:px-0 md:px-0 md: lg:px-0 lg:text-base md:text-sm sm:text-xs lg:h-auto md:h-auto sm:h-auto lg:py-0 md:py-0 sm:py-1">
      ...
      <aside className="grid lg:grid-rows-3 md:grid-rows-3 sm:grid-rows-1 h-80 mb-10 md:mb-0 lg:mb-0 w-90 bg-white lg:w-full md:w-full sm:w-full lg:h-135
       md:h-133 sm:h-auto lg:px-8 md:px-6 sm:px-5 lg:py-4 md:py-3 sm:py-3 rounded-xl shadow-lg">
        <div className="lg:h-auto md:mt-10 sm:h-auto lg:pt-2 md:pt-1 sm:pt-1 px-7 pt-10 sm:px-0 md:px-0 lg:px-0 sm:pt-0 md:pt-0 lg:pt-0 ">
        ...
        <ul className="space-y-2 px-5 sm:px-0 md:px-0 md:h-40 lg:px-0">
          <li>
