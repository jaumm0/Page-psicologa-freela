...
function Contact() {
  return (
    <section id="Contact" className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 w-full px-20 py-20 gap-10 place-items-center">
      <div className="bg-textmain w-160 h-120 px-10 py-10 place-items-center flex justify-center items-center rounded-xl shadow-lg">
        <section className="font-medium text-white text-justify px-10 mb-10 grid lg:grid-rows-3 md:grid-rows-3 sm:grid-rows-1">
          ...
          <div className="pt-5 mb-3">
            <section className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 w-30 items-center gap-4">
              {/* Esquerda -  */}
              ...
              <div className="flex flex-col">
                <p className="font-cormorant font-medium text-xl w-100">
                  ...
                  <p className="font-cormorant font-medium text-base w-100">
          ...
          <button className="bg-textmain cursor-pointer text-white hover:text-textmain transition-all duration-300 font-cormorant font-medium text-xl w-50 h-10 rounded-xl shadow-lg hover:bg-white my-5">
            <a href="">Acessar </a>
        </button>
        </section> 
      </div>
        ...
        <ul className="space-y-3">
          <li>
            <div className="flex items-center mb-5 cursor-pointer shadow-lg h-15 px-5 py-5 hover:scale-x-105 transition-all duration-150">
              ...
              <span className="font-inter font-medium text-ulheader hover:text-textmain transition-colors duration-200 w-full py-4 text-sm">
                (11) 91234-5678
              </span>
            </div>
          </li>
